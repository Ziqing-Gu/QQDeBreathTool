...
class AboutDialog(QDialog):
    def __init__(self, parent=None):
        ...
        text.setHtml(
            ...
            <p>QQDeBreathTool 是一个面向人声后期处理的呼吸声分离工具，用于辅助将人声素材中的 Breath、Vocal Only 与 Noise 区块进行标记、试听和导出。</p>
            <p>软件会基于波形能量、频谱特征和区块边界稳定性自动分析呼吸声候选区域，并在分析时显示百分比进度。用户可以手动调整区块边界、修改区块类型，也可以直接右键区块在 Breath 与 Noise 之间快速切换。</p>
            <p>监听区支持 Voice、Breath、Noise 三路复选监听。未勾选的类型会在波形中以灰色显示，便于判断当前实际听到的内容。Fade 与 Breath Norm 可同步作用于监听；打开 Breath Norm 后，Breath 区块波形也会显示为标准化后的大小。</p>
            ...
            <ul>
              ...
              <li>手动拖动区块边界与修改类型</li>
              <li>支持 Breath / Noise 快捷键标记与右键切换</li>
              <li>支持 Voice、Breath、Noise 复选监听</li>
